...
import { Mail } from "@/app/dashboard/components/data";
import { useMail } from "@/app/dashboard/components/use-mail";

interface MailListProps {
  items: Mail[];
}

export function Notifications({ items }: MailListProps) {
  ...
  return (
    ...
    {/* <div className="flex flex-col items-center text-center">
        <h3 className="text-medium md:text-lg font-bold tracking-tight pt-4">
            Aucune notification
        </h3>
