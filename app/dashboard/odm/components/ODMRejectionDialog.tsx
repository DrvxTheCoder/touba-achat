...
export const ODMRejectionDialog: React.FC<RejectionDialogProps> = ({ isOpen, onClose, onConfirm, odmId, isLoading }) => {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Êtes-vous sûr de vouloir rejeter cet ordre de mission ?
          </DialogDescription>
        </DialogHeader>
