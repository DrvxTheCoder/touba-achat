...
export default function ResponsiveStockEdbDialog({
  categories,
  departments,
  onSubmit
}: StockEdbDialogProps) {
  ...
  const StockEdbForm = ({ className }: React.ComponentProps<"form">) => (
    <Form {...form}>
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent>
        <DrawerHeader className="text-left">
          <DrawerTitle>Demande d&apos;Articles en Stock</DrawerTitle>
          <DrawerDescription>
            Formulaire pour les articles disponibles directement en stock.
          </DrawerDescription>
        </DrawerHeader>
